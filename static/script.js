...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const allNavLinks = navLinks.querySelectorAll('a:not(.user-profile-btn):not(.dropdown-item)');
    ...
    allNavLinks.forEach(link => {
        link.addEventListener('click', function(e) {
            ...
            if (window.innerWidth <= 768) {
                // If link has valid href (not # or empty) and not a dropdown toggle
                if (href && href !== '#' && href !== '' && !this.classList.contains('user-profile-btn')) {
